...
4. **Respects the Day-7 scope boundary.** Staying out of the critic node avoids the `source_text` truncation / cache cost-paths that are addressed in the Day-10 cost-model pass (calendar Day 11 / `docs/plan/day10.md`).
